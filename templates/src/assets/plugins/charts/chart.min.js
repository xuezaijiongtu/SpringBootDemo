    ...
    return function t(e, a, i) {
        ...
        3 : [function(t, e, a) {
            ...
            o = function(t) {
                ...
                var e;
                if ("string" == typeof t) if (e = n.getRgba(t)) this.setValues("rgb", e);
            ...
            o.prototype.getValues = function(t) {
                ...
                a = {},
                i = 0; i < t.length; i++) a[t.charAt(i)] = e[t][i];
            ...
            o.prototype.setValues = function(t, e) {
                ...
                l = 1;
                if ("alpha" === t) l = e;
                else if (e.length) n[t] = e.slice(0, t.length),
                l = e[t.length];
                ...
                var d;
                for (a = 0; a < t.length; a++) d = Math.max(0, Math.min(r[t][a], n[t][a])),
                n[t][a] = Math.round(d);
        ...
        4 : [function(t, e, a) {
            ...
            function B(t) {
                ...
                r = t[1],
                l = t[2];
                return 8 >= o ? (a = 100 * o / 903.3, n = 7.787 * (a / 100) + 16 / 116) : (a = 100 * Math.pow((o + 16) / 116, 3), n = Math.pow(a / 100, 1 / 3)),
            ...
            e.exports = function(t) {
                ...
                t.controllers.bar = t.DatasetController.extend({
                    ...
                    getBarCount: function() {
                        var t = this,
                        a = 0;
                        return e.each(t.chart.data.datasets,
                        function(e, i) {
                    ...
                    getBarIndex: function(t) {
                        var e, a, i = 0;
                        for (a = 0; t > a; ++a) e = this.chart.getDatasetMeta(a),
            ...
            e.exports = function(t) {
                ...
                a.doughnut = {
                    ...
                    legendCallback: function(t) {
                        ...
                        i = a.datasets,
                        n = a.labels;
                        if (i.length) for (var o = 0; o < i[0].data.length; ++o) e.push('<li><span style="background-color:' + i[0].backgroundColor[o] + '"></span>'),
                        n[o] && e.push(n[o]),
                        e.push("</li>");
                        return e.push("</ul>"),
                        e.join("")
                    ...
                    legend: {
                        ...
                        onClick: function(t, e) {
                            var a, i, n, o = e.index,
                            r = this.chart;
                            for (a = 0, i = (r.data.datasets || []).length; i > a; ++a) n = r.getDatasetMeta(a),
                    ...
                    tooltips: {
                        callbacks: {
                            ...
                            label: function(t, a) {
                                ...
                                return e.isArray(i) ? (i = i.slice(), i[0] += n) : i += n,
                                i
                            }
                        }
                    }
                ...
                t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                    ...
                    getRingIndex: function(t) {
                        for (var e = 0,
                        a = 0; t > a; ++a) this.chart.isDatasetVisible(a) && ++e;
                        return e
                    },
                    update: function(t) {
                        var a = this,
                    ...
                    getMaxBorderWidth: function(t) {
                        ...
                        n = this.index,
                        o = t.length,
                        r = 0; o > r; r++) e = t[r]._model ? t[r]._model.borderWidth: 0,
            ...
            e.exports = function(t) {
                ...
                t.controllers.line = t.DatasetController.extend({
                    ...
                    update: function(t) {
                        ...
                        g = e(f, u);
                        for (g && (o = s.custom || {},
                        void 0 !== f.tension && void 0 === f.lineTension && (f.lineTension = f.tension), s._scale = h, s._datasetIndex = r.index, s._children = d, s._model = {
                    ...
                    updateBezierControlPoints: function() {
                        ...
                        else for (e = 0, i = u.length; i > e; ++e) n = u[e],
                        o = n._model,
                        ...
                        if (l.chart.options.elements.line.capBezierPoints) for (e = 0, i = u.length; i > e; ++e) o = u[e]._model,
            ...
            e.exports = function(t) {
                ...
                t.controllers.polarArea = t.DatasetController.extend({
                    ...
                    updateElement: function(t, a, i) {
                        for (var n = this,
                        o = n.chart,
                        r = n.getDataset(), l = o.options, s = l.animation, d = o.scale, u = e.getValueAtIndexOrDefault, c = o.data.labels, h = n.calculateCircumference(r.data[a]), f = d.xCenter, g = d.yCenter, p = 0, m = n.getMeta(), b = 0; a > b; ++b) isNaN(r.data[b]) || m.data[b].hidden || ++p;
                        var v = l.startAngle,
            ...
            e.exports = function(t) {
                ...
                t.animationService = {
                    ...
                    cancelAnimation: function(t) {
                        var a = e.findIndex(this.animations,
                        function(e) {
                    ...
                    startDigest: function() {
                        ...
                        for (var i = 0; i < t.animations.length;) null === t.animations[i].animationObject.currentStep && (t.animations[i].animationObject.currentStep = 0),
                        ...
                        t.animations[i].animationObject.currentStep === t.animations[i].animationObject.numSteps ? (t.animations[i].animationObject.onAnimationComplete && t.animations[i].animationObject.onAnimationComplete.call && t.animations[i].animationObject.onAnimationComplete.call(t.animations[i].chartInstance, t.animations[i]), t.animations[i].chartInstance.animating = !1, t.animations.splice(i, 1)) : ++i;
                        var n = Date.now(),
        ...
        23 : [function(t, e, a) {
            ...
            e.exports = function(t) {
                ...
                function a(t, a) {
                    ...
                    if (null === n || "" === n) if ("" === t.style.height) t.height = t.width / (a.options.aspectRatio || 2);
                    else {
                        var l = e(t, "height");
                        void 0 !== r && (t.height = l)
                    }
                ...
                function n(t, e) {
                    if ("string" == typeof t ? t = document.getElementById(t) : t.length && (t = t[0]), t && t.canvas && (t = t.canvas), t instanceof HTMLCanvasElement) {
                        ...
                        if (i instanceof CanvasRenderingContext2D) return a(t, e),
                        i
                    }
                    return null
                }
                ...
                t.Controller = function(e, a, i) {
                    ...
                    s && d ? (r.retinaScale(i), l.options.responsive && (r.addResizeListener(d.parentNode,
                    function() {
                        l.resize()
                ...
                r.extend(t.Controller.prototype, {
                    ...
                    buildOrUpdateControllers: function() {
                        ...
                        a = [],
                        i = [];
                        if (r.each(e.data.datasets,
                        function(n, o) {
                            var r = e.getDatasetMeta(o);
                            r.type || (r.type = n.type || e.config.type),
                            a.push(r.type),
                            r.controller ? r.controller.updateIndex(o) : (r.controller = new t.controllers[r.type](e, o), i.push(r.controller))
                        },
                    ...
                    destroy: function() {
                        var e, a, n, o = this,
                        l = o.chart.canvas;
                        for (o.stop(), a = 0, n = o.data.datasets.length; n > a; ++a) e = o.getDatasetMeta(a),
                        e.controller && (e.controller.destroy(), e.controller = null);
                        l && (r.unbindEvents(o, o.events), r.removeResizeListener(l.parentNode), r.clear(o.chart), i(l), o.chart.canvas = null, o.chart.ctx = null),
                    ...
                    bindEvents: function() {
                        var t = this;
                        r.bindEvents(t, t.options.events,
                        function(e) {
                            t.eventHandler(e)
                        })
                    },
                    updateHoverStyle: function(t, e, a) {
                        ...
                        for (n = 0, o = t.length; o > n; ++n) i = t[n],
                    ...
                    eventHandler: function(t) {
                        ...
                        return r ? e.render(r.duration, r.lazy) : o && !e.animating && (e.stop(), e.render(n.animationDuration, !0)),
                        e._bufferedRender = !1,
                        e._bufferedRequest = null,
                        e
                    },
        ...
        24 : [function(t, e, a) {
            ...
            e.exports = function(t) {
                    ...
                    return t._chartjs ? void t._chartjs.listeners.push(e) : (Object.defineProperty(t, "_chartjs", {
                        ...
                        Object.defineProperty(t, e, {
                            ...
                            value: function() {
                                ...
                                o = n.apply(this, e);
                                return i.each(t._chartjs.listeners,
                                function(t) {
                ...
                function a(t, e) {
                    ...
                    if (a) {
                        var i = a.listeners,
                        o = i.indexOf(e); - 1 !== o && i.splice(o, 1),
            ...
            e.exports = function(t) {
                ...
                e.extend(t.Element.prototype, {
                    ...
                    transition: function(t) {
                        ...
                        1 === t ? (a._view = a._model, a._start = null, a) : (a._start || a.pivot(), e.each(a._model,
                        function(i, n) {
                            if ("_" === n[0]);
                            else if (a._view.hasOwnProperty(n)) if (i === a._view[n]);
        ...
        26 : [function(t, e, a) {
            ...
            e.exports = function(t) {
                function e(t, e, a) {
                    var i;
                    return "string" == typeof t ? (i = parseInt(t, 10), -1 !== t.indexOf("%") && (i = i / 100 * e.parentNode[a])) : i = t,
                    i
                }
                function a(t) {
                ...
                o.each = function(t, e, a, i) {
                    var n, r;
                    if (o.isArray(t)) if (r = t.length, i) for (n = r - 1; n >= 0; n--) e.call(a, t[n], n);
                ...
                o.scaleMerge = function(e, a) {
                    ...
                    return o.each(a,
                    function(e, a) {
                        "xAxes" === a || "yAxes" === a ? i.hasOwnProperty(a) ? o.each(e,
                        function(e, n) {
                ...
                function(t, e) {
                    ...
                    for (var a = 0,
                    i = t.length; i > a; ++a) if (t[a] === e) return a;
                    return - 1
                },
                ...
                function(t, e, a) {
                    ...
                    a = void 0 === a ? t: a;
                    for (var i = 0,
                    n = t.length; n > i; ++i) if (e.call(a, t[i], i, t)) return i;
                    return - 1
                },
                o.findNextWhere = function(t, e, a) { (void 0 === a || null === a) && (a = -1);
                    for (var i = a + 1; i < t.length; i++) {
                        var n = t[i];
                        if (e(n)) return n
                    }
                },
                o.findPreviousWhere = function(t, e, a) { (void 0 === a || null === a) && (a = t.length);
                    for (var i = a - 1; i >= 0; i--) {
                        var n = t[i];
                        if (e(n)) return n
                    }
                ...
                o.splineCurveMonotone = function(t) {
                    ...
                    l = r.length;
                    for (e = 0; l > e; ++e) i = r[e],
                    i.model.skip || (a = e > 0 ? r[e - 1] : null, n = l - 1 > e ? r[e + 1] : null, n && !n.model.skip && (i.deltaK = (n.model.y - i.model.y) / (n.model.x - i.model.x)), !a || a.model.skip ? i.mK = i.deltaK: !n || n.model.skip ? i.mK = a.deltaK: this.sign(a.deltaK) !== this.sign(i.deltaK) ? i.mK = 0 : i.mK = (a.deltaK + i.deltaK) / 2);
                    var s, d, u, c;
                    for (e = 0; l - 1 > e; ++e) i = r[e],
                    n = r[e + 1],
                    i.model.skip || n.model.skip || (o.almostEquals(i.deltaK, 0, this.EPSILON) ? i.mK = n.mK = 0 : (s = i.mK / i.deltaK, d = n.mK / i.deltaK, c = Math.pow(s, 2) + Math.pow(d, 2), 9 >= c || (u = 3 / Math.sqrt(c), i.mK = s * u * i.deltaK, n.mK = d * u * i.deltaK)));
                    var h;
                    for (e = 0; l > e; ++e) i = r[e],
                    i.model.skip || (a = e > 0 ? r[e - 1] : null, n = l - 1 > e ? r[e + 1] : null, a && !a.model.skip && (h = (i.model.x - a.model.x) / 3, i.model.controlPointPreviousX = i.model.x - h, i.model.controlPointPreviousY = i.model.y - h * i.mK), n && !n.model.skip && (h = (n.model.x - i.model.x) / 3, i.model.controlPointNextX = i.model.x + h, i.model.controlPointNextY = i.model.y + h * i.mK))
                },
                ...
                o.longestText = function(t, e, a, i) {
                    ...
                    o.each(a,
                    function(e) {
                        void 0 !== e && null !== e && o.isArray(e) !== !0 ? l = o.measureText(t, n, r, l, e) : o.isArray(e) && o.each(e,
                        function(e) {
                ...
                o.measureText = function(t, e, a, i, n) {
                    var o = e[n];
                    return o || (o = e[n] = t.measureText(n).width, a.push(n)),
                    o > i && (i = o),
                    i
                },
                ...
                o.addResizeListener = function(t, e) {
                    ...
                    n = function() {
                        i.ticking || (i.ticking = !0, o.requestAnimFrame.call(window,
                        function() {
                ...
                t.layoutService = {
                    ...
                    update: function(t, a, i) {
                        function n(t) {
                            ...
                            a ? (e = t.update(t.options.fullWidth ? x: C, M), D -= e.height) : (e = t.update(w, S), C -= e.width),
                            I.push({
                                horizontal: a,
                                minSize: e,
                                box: t
                ...
                t.Legend = t.Element.extend({
                    ...
                    fit: function() {
                        ...
                        if (m ? (p.width = i.maxWidth, p.height = r ? 10 : 0) : (p.width = r ? 10 : 0, p.height = i.maxHeight), r) if (l.font = f, m) {
                            ...
                            l.textAlign = "left",
                            l.textBaseline = "top",
                            a.each(i.legendItems,
                            function(t, a) {
                                var n = e(o, u),
                                r = n + u / 2 + l.measureText(t.text).width;
                                b[b.length - 1] + r + o.padding >= i.width && (v += u + o.padding, b[b.length] = i.left),
                                g[a] = {
                                    left: 0,
                                    top: 0,
                                    width: r,
                    ...
                    draw: function() {
                        ...
                        if (n.display) {
                            ...
                            k = function(t, e, a, i) {
                                ...
                                a.hidden && (c.beginPath(), c.lineWidth = 2, c.moveTo(v + g / 2 + t, e + g / 2), c.lineTo(v + g / 2 + t + i, e + g / 2), c.stroke())
                            },
                            S = i.isHorizontal();
                            u = S ? {
                                x: i.left + (s - d[0]) / 2,
                    ...
                    handleEvent: function(t) {
                        ...
                        l = r.x,
                        s = r.y;
                        if (l >= e.left && l <= e.right && s >= e.top && s <= e.bottom) for (var d = e.legendHitBoxes,
                        u = 0; u < d.length; ++u) {
                            var c = d[u];
                ...
                t.Scale = t.Element.extend({
                    ...
                    draw: function(a) {
                        ...
                        if (n.display) {
                            ...
                            var F = [];
                            if (g) {
                                if (o = !1, h && (P /= 2), (P + d.autoSkipPadding) * i.ticks.length > i.width - (i.paddingLeft + i.paddingRight) && (o = 1 + Math.floor((P + d.autoSkipPadding) * i.ticks.length / (i.width - (i.paddingLeft + i.paddingRight)))), r && i.ticks.length > r) for (; ! o || i.ticks.length / (o || 1) > r;) o || (o = 1),
                                o += 1;
                                f || (o = !1)
                            }
                            ...
                            function(t) {
                                if (u.display && (l.save(), l.lineWidth = t.glWidth, l.strokeStyle = t.glColor, l.setLineDash && (l.setLineDash(t.glBorderDash), l.lineDashOffset = t.glBorderDashOffset), l.beginPath(), u.drawTicks && (l.moveTo(t.tx1, t.ty1), l.lineTo(t.tx2, t.ty2)), u.drawOnChartArea && (l.moveTo(t.x1, t.y1), l.lineTo(t.x2, t.y2)), l.stroke(), l.restore()), d.display) {
                                    ...
                                    n = -(a.length - 1) * m * .75; i < a.length; ++i) l.fillText("" + a[i], 0, n),
                                    n += 1.5 * m;
                                ...
                                var O, B, W = 0;
                                if (g) O = i.left + (i.right - i.left) / 2,
            ...
            e.exports = function(t) {
                ...
                t.Title = t.Element.extend({
                    ...
                    fit: function() {
                        ...
                        s = a.minSize;
                        a.isHorizontal() ? (s.width = a.maxWidth, s.height = r ? l + 2 * n.padding: 0) : (s.width = r ? l + 2 * n.padding: 0, s.height = a.maxHeight),
                        a.width = s.width,
                        a.height = s.height
                    },
                    afterFit: a,
                    ...
                    draw: function() {
                        ...
                        if (o.display) {
                            ...
                            i.font = f,
                            a.isHorizontal() ? (l = m + (v - m) / 2, s = p + (b - p) / 2, d = v - m) : (l = "left" === o.position ? m + u / 2 : v - u / 2, s = p + (b - p) / 2, d = b - p, g = Math.PI * ("left" === o.position ? -.5 : .5)),
                            i.save(),
                            i.translate(l, s),
                            i.rotate(g),
                            i.textAlign = "center",
            ...
            e.exports = function(t) {
                ...
                t.Tooltip = t.Element.extend({
                    ...
                    drawCaret: function(t, a, i) {
                        ...
                        v = a.width,
                        x = a.height;
                        "center" === p ? ("left" === g ? (n = m, o = n - h, r = n) : (n = m + v, o = n + h, r = n), s = b + x / 2, l = s - h, d = s + h) : ("left" === g ? (n = m + f, o = n + h, r = o + h) : "right" === g ? (n = m + v - f, o = n - h, r = o - h) : (o = m + v / 2, n = o - h, r = o + h), "top" === p ? (l = b, s = l - h, d = l) : (l = b + x, s = l + h, d = l)),
                    ...
                    drawTitle: function(t, a, i, n) {
                        ...
                        if (o.length) {
                            ...
                            var d, u;
                            for (d = 0, u = o.length; u > d; ++d) i.fillText(o[d], t.x, t.y),
                            t.y += r + l,
                    ...
                    drawBody: function(t, a, i, n) {
                        ...
                        function(r, l) {
                            ...
                            s.each(r.lines,
                            function(r) {
                                h && (i.fillStyle = e(a.legendColorBackground, n), i.fillRect(t.x, t.y, o, o), i.strokeStyle = e(a.labelColors[l].borderColor, n), i.strokeRect(t.x, t.y, o, o), i.fillStyle = e(a.labelColors[l].backgroundColor, n), i.fillRect(t.x + 1, t.y + 1, o - 2, o - 2), i.fillStyle = d),
                                c(r)
                            }),
                            s.each(r.after, c)
                        }),
                    ...
                    drawFooter: function(t, a, i, n) {
                        var o = a.footer;
                        o.length && (t.y += a.footerMarginTop, i.textAlign = a._footerAlign, i.textBaseline = "top", i.fillStyle = e(a.footerFontColor, n), i.font = s.fontString(a.footerFontSize, a._footerFontStyle, a._footerFontFamily), s.each(o,
                        function(e) {
            ...
            e.exports = function(t) {
                ...
                t.elements.Line = t.Element.extend({
                    draw: function() {
                        ...
                        var c, h, f, g;
                        if (d.length && n.fill) {
                            for (s.beginPath(), c = 0; c < d.length; ++c) h = d[c],
                            f = e.previousItem(d, c),
                            g = h._view,
                            0 === c ? (l ? s.moveTo(r.x, r.y) : s.moveTo(g.x, r), g.skip || (u = c, s.lineTo(g.x, g.y))) : (f = -1 === u ? f: d[u], g.skip ? o || u !== c - 1 || (l ? s.lineTo(r.x, r.y) : s.lineTo(f._view.x, r)) : (u !== c - 1 ? o && -1 !== u ? t(f, h) : l ? s.lineTo(g.x, g.y) : (s.lineTo(g.x, r), s.lineTo(g.x, g.y)) : t(f, h), u = c));
                    ...
                    determineDataLimits: function() {
                        ...
                        if (a.min = null, a.max = null, i.stacked) {
                            ...
                            function(o, r) {
                                ...
                                n.isDatasetVisible(r) && t(l) && e.each(o.data,
                                function(t, e) {
                        ...
                        function(i, o) {
                            ...
                            n.isDatasetVisible(o) && t(r) && e.each(i.data,
                            function(t, e) {
            ...
            e.exports = function(t) {
                ...
                i = t.Scale.extend({
                    determineDataLimits: function() {
                        ...
                        if (a.min = null, a.max = null, a.minNotZero = null, i.stacked) {
                            ...
                            function(n, r) {
                                ...
                                o.isDatasetVisible(r) && t(l) && (void 0 === u[l.type] && (u[l.type] = []), e.each(n.data,
                                function(t, e) {
                                    var n = u[l.type],
                                    o = +a.getRightValue(t);
                        ...
                        function(i, n) {
                            ...
                            o.isDatasetVisible(n) && t(r) && e.each(i.data,
                            function(t, e) {
                                var i = +a.getRightValue(t);
                    ...
                    buildTicks: function() {
                        ...
                        a.max = e.max(r),
                        a.min = e.min(r),
                        n.reverse ? (r.reverse(), a.start = a.max, a.end = a.min) : (a.start = a.min, a.end = a.max)
                    },
                    convertTicksToLabels: function() {
                        ...
                        if (i.display) {
                            ...
                            function(r, l) {
                                if (l > 0 || i.reverse) {
                                    ...
                                    h = t.yCenter - c;
                                    if (n.display && 0 !== l) if (d.strokeStyle = e.getValueAtIndexOrDefault(n.color, l - 1), d.lineWidth = e.getValueAtIndexOrDefault(n.lineWidth, l - 1), i.lineArc) d.beginPath(),
            ...
            e.exports = function(t) {
                ...
                o = t.Scale.extend({
                    ...
                    determineDataLimits: function() {
                        ...
                        t.labelMoments = [];
                        var a = [];
                        t.chart.data.labels && t.chart.data.labels.length > 0 ? (e.each(t.chart.data.labels,
                        function(e) {
                            var i = t.parseTime(e);
                            i.isValid() && (t.options.time.round && i.startOf(t.options.time.round), a.push(i))
                        },
                        t), t.firstTick = i.min.call(t, a), t.lastTick = i.max.call(t, a)) : (t.firstTick = null, t.lastTick = null),
                        e.each(t.chart.data.datasets,
                        function(n, o) {
                            var r = [],
                            l = t.chart.isDatasetVisible(o);
                            "object" == typeof n.data[0] && null !== n.data[0] ? e.each(n.data,
                            function(e) {
                    ...
                    buildTicks: function() {
                        ...
                        if (i.ctx.font = l, i.ticks = [], i.unitScale = 1, i.scaleSizeInUnits = 0, i.options.time.unit) i.tickUnit = i.options.time.unit || "day",
                        ...
                        var M = i.ticks[i.ticks.length - 1].diff(i.lastTick, i.tickUnit); (0 !== M || 0 === i.scaleSizeInUnits) && (i.options.time.max ? (i.ticks.push(i.lastTick.clone()), i.scaleSizeInUnits = i.lastTick.diff(i.ticks[0], i.tickUnit, !0)) : (i.ticks.push(i.lastTick.clone()), i.scaleSizeInUnits = i.lastTick.diff(i.firstTick, i.tickUnit, !0))),
                        i.ctx.restore(),
                        i.labelDiffs = void 0
                    },
                    getLabelForIndex: function(t, e) {
