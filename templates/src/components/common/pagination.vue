...
<nav>
    ...
    <div class="pagination-input">跳转到：
        <input type="text" class="txt" v-model="pageInput">
        <input type="button" class="btn" value="GO" @click.prevent="changePage(pageInput)">
    </div>
</nav>	
</template>
...
<script>
    ...
    data(){
        return{
            pageInput:this.pagination.current_page
        }
    },
    computed: {
        array () {
    ...
    methods: {
        ...
        changePage (page) {
            if (this.pagination.current_page === page) {
                ...
                return;
            }else if(page < 0 || page > this.pagination.last_page){
                return;
            }
